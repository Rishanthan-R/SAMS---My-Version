...
export function SetupPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Clear force_password_reset flag in profiles
      ...
      // 3. Reload page to trigger context update and redirect
      ...
      >
        <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-50">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Setup Your Password</h2>
            <p className="text-sm text-gray-500">
              Welcome {profile?.full_name}! Please set a new password to secure your account before continuing.
            </p>
          </div>
